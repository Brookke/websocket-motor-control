...
VirtualJoystick.prototype.X	= function(){ return  (this._stickX - this._baseX)	}
VirtualJoystick.prototype.Y = function(){ return -(this._stickY - this._baseY)	}

//These functions were added by me to control the wheels
VirtualJoystick.prototype.pwmL = function(){
    	if( this.Y() >= 0 ) {
...
VirtualJoystick.prototype.pwmR = function(){
    	if( this.Y() >= 0 ) {
			return (this.Y()-this.X())/100;
		} else {
		    return (this.Y()+this.X())/100;
